...
class ETL:
    ...
    def etl():
        """
        Gathers data from a url and creates a CSV. Saves two df's to a csv locally. 
        Args: none
        Returns: none
        """
        ...
        pred_universe_raw.to_csv('data/pred_universe_raw.csv')
        arrest_events_raw.to_csv('data/arrest_events_raw.csv')
